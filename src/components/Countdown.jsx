...
export default function Countdown() {
  ...
  return (
    <div
      className="w-full flex flex-col items-center text-center select-none relative"
      style={{
        padding: "0 clamp(12px, 4vw, 48px)",
        paddingTop: "clamp(20px, 6vw, 50px)",
      }}
    >
      <Butterflies count={4} size={{ min: 20, max: 30 }} />
      {/* Titre */}
      <h3
        className="font-script font-medium text-olive-dark max-w-2xl w-full text-start"
        style={{
          fontSize: "clamp(38px, 7vw, 72px)",
          marginBottom: "clamp(-10px, -1.5vw, -6px)",
        }}
      >
        Le compte à rebours
      </h3>
          ...
          <>
            ...
            >
              <span
                ...
                style={{ fontSize: "clamp(26px, 7vw, 62px)" }}
              >
      ...
      >
        ...
        <img
          ...
          style={{
            right: "clamp(-60px, -14%, -40px)",
            top: "clamp(-100px, -30%, -40px)",
